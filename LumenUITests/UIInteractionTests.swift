...
/// UI Interaction Tests - Merged from:
/// - PrintDialogTests (VAL-E2E-012)
/// - DistractionFreeTests (VAL-E2E-013)
/// - PageNavHistoryTests (VAL-E2E-011)
@MainActor
final class UIInteractionTests: XCTestCase {
    ...
    // MARK: - From PrintDialogTests (VAL-E2E-012)
    ...
    // MARK: - From DistractionFreeTests (VAL-E2E-013)
    ...
    // MARK: - From PageNavHistoryTests (VAL-E2E-011)
    ...
    /// Creates a universal simple PDF for UI interaction tests
    private func createUniversalPDF() -> URL {
        let pdfURL = FileManager.default.temporaryDirectory.appendingPathComponent("UIInteractionTest_\(UUID().uuidString).pdf")
        let text = "UI Test PDF - Page 1"
        let pdfContent = """
        %PDF-1.4
